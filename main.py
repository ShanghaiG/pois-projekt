...
def load_image():
	...
	Red_pixels = np.argwhere(cv2.inRange(img, (255, 0, 0), (255, 2, 2)))
	...
	cv2.circle(img, (Red_pixels[0][1], Red_pixels[0][0]), 5, (0, 255, 255), 1)
	cv2.imwrite("out.jpeg", img)
	center = (Red_pixels[0][1], Red_pixels[0][0])
	line1 = (0,0)
	line2 = (0, width)
	line3 = (height, width)
	line4 = (height, 0)
	line5 = (height, Red_pixels[0][0])
	line6 = (Red_pixels[0][1], width)
	line7 = (Red_pixels[0][1], 0)
	line8 = (0, Red_pixels[0][0])
